...
const editObserver = new MutationObserver((mutation_list) => {
  for (let mutation of mutation_list) {
    if (mutation.addedNodes.length) {
      ...
      optButton
        .querySelector("svg")
        .appendChild(document.querySelector(".main-playlistEditDetailsModal-closeBtn path").cloneNode());
      ...
      popupContent.appendChild(bannerSelect);
      popupContent.appendChild(bannerInput);
